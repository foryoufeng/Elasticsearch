...
use Foryoufeng\Elasticsearch\Commands\ReindexCommand;
use Elasticsearch\ClientBuilder as ElasticBuilder;
use Illuminate\Contracts\Container\BindingResolutionException;
use Illuminate\Support\ServiceProvider;
use Laravel\Scout\EngineManager;
use Foryoufeng\Elasticsearch\Commands\ListIndicesCommand;
use Foryoufeng\Elasticsearch\Commands\CreateIndexCommand;
use Foryoufeng\Elasticsearch\Commands\DropIndexCommand;
use Foryoufeng\Elasticsearch\Commands\UpdateIndexCommand;

/**
 * Class ElasticsearchServiceProvider
 * @package Foryoufeng\Elasticsearch
 */
